...
#endif
{
    ...
    case 2:
    {
        ...
        Camera camera = {
            .position = {0, 40, 60},
            .forward = {0.129410, -0.339138, -0.931793},
            .right = {0.990493, -0.000000, 0.137562},
            .up = {0.046653, 0.940737, -0.335913},
            .yaw = -M_PI,
            .pitch = 0,
            .fov = 45.0f,
            .move = 0};
        ...
        BVHNode *root = build_bvh_node(scene, 0, scene->count, 0);
                ...
                if (camera.move)
                {
                    ...
                    for (int y = 0; y < HEIGHT; y++)
                    {
                        for (int x = 0; x < WIDTH; x++)
                        {
                            ...
                            SDL_Color color = trace_ray(ray, scene, scene->count, MAX_DEPTH, use_bvh ? root : NULL);
